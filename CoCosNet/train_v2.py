...
from trainers.pix2pix_trainer_v1 import Pix2PixTrainer
...
#torch.manual_seed(0)
# load the dataset
dataset = IllustDataset(Path("/archive/zhaowei/art-landscape-rgb-512/imgs"),
                         Path("/archive/zhaowei/art-landscape-rgb-512/sketchs"),
                         ["xdog", "pencil", "blend"],
                         "png",
                         256,
                         256,
